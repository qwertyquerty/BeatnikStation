...
/datum/subsystem/ticker/New()
	...
	login_music = pickweight(list('sound/ambience/title2.ogg' = 0, 'sound/ambience/title1.ogg' = 1, 'sound/ambience/title3.ogg' = 0, 'sound/ambience/clown.ogg' = 0, 'sound/ambience/title4.ogg' = 1)) // choose title music!
